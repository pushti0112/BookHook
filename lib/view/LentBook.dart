...
class LentBook extends StatefulWidget {
  const LentBook({Key? key}) : super(key: key);

  @override
  _LentBookState createState() => _LentBookState();
}

class _LentBookState extends State<LentBook> {
  @override
